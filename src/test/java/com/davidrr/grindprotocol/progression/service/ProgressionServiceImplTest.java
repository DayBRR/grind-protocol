...
class ProgressionServiceImplTest {
    ...
    @Test
    @DisplayName("Debe sumar XP y Core Points al perfil cuando se completa una tarea")
    void applyTaskCompletionProgress_shouldAddXpAndCorePointsToProfile() {
    ...
    @Test
    @DisplayName("Debe permitir sumar cero XP y cero Core Points")
